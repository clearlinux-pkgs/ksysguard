...
Version  : 5.17.2
Release  : 30
URL      : https://download.kde.org/stable/plasma/5.17.2/ksysguard-5.17.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.17.2/ksysguard-5.17.2.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.17.2/ksysguard-5.17.2.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572439312
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksysguard-5.17.2/COPYING %{buildroot}/usr/share/package-licenses/ksysguard/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/ksysguard-5.17.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/ksysguard/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang ksysguard
