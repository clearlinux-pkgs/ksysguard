...
Version  : 5.21.4
Release  : 52
URL      : https://download.kde.org/stable/plasma/5.21.4/ksysguard-5.21.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.21.4/ksysguard-5.21.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.21.4/ksysguard-5.21.4.tar.xz.sig
...
%prep
%setup -q -n ksysguard-5.21.4
cd %{_builddir}/ksysguard-5.21.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618664914
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksysguard-5.21.4/COPYING %{buildroot}/usr/share/package-licenses/ksysguard/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/ksysguard-5.21.4/COPYING.DOC %{buildroot}/usr/share/package-licenses/ksysguard/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang ksysguard
...
/usr/lib64/qt5/plugins/ksysguard/ksysguard_plugin_cpu.so
/usr/lib64/qt5/plugins/ksysguard/ksysguard_plugin_disk.so
/usr/lib64/qt5/plugins/ksysguard/ksysguard_plugin_gpu.so
/usr/lib64/qt5/plugins/ksysguard/ksysguard_plugin_memory.so
/usr/lib64/qt5/plugins/ksysguard/ksysguard_plugin_osinfo.so
/usr/lib64/qt5/plugins/ksysguard/ksysguard_plugin_power.so
